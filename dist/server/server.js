...
class App {
    constructor(port) {
        ...
        app.use('/vectorHelper', express_1.default.static(path_1.default.join(__dirname, '../client/vectorHelper.js')));
        app.use('/magicCube', express_1.default.static(path_1.default.join(__dirname, '../client/magicCube.js')));
